...
import json
from typing import Any, Dict, Iterable, Optional, List, Union, Generator, TYPE_CHECKING
...
class OpenAIChatCompletion(ChatCompletion):
    ...
    def invoke(
        ...
        **kwargs: Any
        ...
        if stream:
            ...
            # Enable usage in stream if not explicitly disabled
    ...
    def _format_single_message(self, msg: Message) -> Dict[str, Any]:
        ...
        if isinstance(msg, SystemMessage):
            # Combine text blocks into single content
    ...
    def _format_content_blocks(
        ...
        for block in content:
            if isinstance(block, TextBlock):
                ...
                # OpenAI doesn't have native document support
