...
Demonstrates function/tool calling with the OpenAI provider.
"""
...
def get_weather(location: str, unit: str = "celsius") -> dict:
    ...
    # In real usage, this would call an actual weather API
    weather_data = {
...
def main():
    ...
    print("=" * 50)
    print("Example 2: Full conversation with tool execution")
    print("=" * 50)
    ...
    # First API call
    response = chat.invoke(messages=messages, tools=tools)
    ...
    if response.tool_calls:
        ...
        final_response = chat.invoke(messages=messages, tools=tools)
    ...
    print("=" * 50)
    print("Example 3: Streaming with tool calls")
    print("=" * 50)
